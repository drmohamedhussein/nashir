...
function rpsite_mock_calendar(): void {
	$days = 'en' === rpsite_locale() ? array( 'S', 'S', 'M', 'T', 'W', 'T', 'F' ) : array( 'س', 'ح', 'ن', 'ث', 'ر', 'خ', 'ج' );
...
function rpsite_mock_schedule(): void {
	$rows = array(
		array( '08:00', 'publish' ),
		array( '11:30', 'future' ),
		array( '16:00', 'draft' ),
	...
	echo '<div class="mock-scene mock-scene-schedule"><div class="mock"><div class="mock-head">' . esc_html( rpsite_t( 'f2t' ) ) . '<span class="pill">auto</span></div>';
	foreach ( $rows as $row ) {
...
function rpsite_mock_social(): void {
	echo '<div class="mock-scene mock-scene-social"><div class="mock"><div class="mock-head">' . esc_html( rpsite_t( 'nav_social' ) ) . '</div><div class="social-tiles">';
...
function rpsite_mock_bars(): void {
	echo '<div class="mock-scene mock-scene-bars"><div class="mock"><div class="mock-head">' . esc_html( rpsite_t( 'f5t' ) ) . '</div><div class="bars">';
...
function rpsite_mock_templates(): void {
...
function rpsite_mock_editors(): void {
	echo '<div class="mock-scene mock-scene-editors"><div class="mock"><div class="mock-head">' . esc_html( rpsite_t( 'f6t' ) ) . '</div>';
...
function rpsite_render_mock( string $name ): void {
	$map = array(
		'calendar' => 'hero.jpg',
